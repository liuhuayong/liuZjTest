...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7128";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">投资人支付成功通知（7128）</td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="OrderNo" size="40" value="132456456456" />
          </td>
        </tr> 
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24">银行通知时间</td>
          <td width="*" class="content">
            <input type="text" name="BankTxTime" size="40" value="20131020012301" />
          </td>
        </tr>
      </table>
      ...
      <input type="hidden" name="TxCode" value="7128" />
    </form>
