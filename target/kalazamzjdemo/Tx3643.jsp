...
<%
    String action = contextPath + "/Tx3643";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">P2P项目还款（从担保公司或平台的支付账户）（3643）</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>还款流水号</td>
        <td width="*" class="content">
            <input type="text" name="RepaymentNo" size="40" value="<%=GUIDGenerator.genGUID()%>"/>
        </td>
    </tr>
    <tr class="mouseout">
