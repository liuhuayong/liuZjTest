...
import payment.api.tx.consumptionfinancial.Tx8212Request;
 ...
 * </pre>
 */
public class Tx8212 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8212Request txRequest = new Tx8212Request();
            ...
            request.setAttribute("txCode", "8212");
            request.setAttribute("txName", "贷款项目发布查询");
