...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx2011";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="Amount" size="40" value="1000" onkeyup="this.value=this.value.replace(/[^\d]/g,'');"/>
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <select id="AccountType" name="IdentificationType" style="width: 274">
        ...
        <tr class="mouseout">
         <td width="120" class="label" height="24">证件号码</td>
          <td width="*" class="content">
            <input type="text" name="IdentificationNumber" size="40" value="" /><font id="rulet" style="display:none" color="#FF0000" size="2"><b>测试环境交易状态返回规则：备注字段填‘10’返回成功状态；填‘20’返回失败状态；填‘30’返回处理中状态</b></font><%if(debugMode=="20"){ %>test="123456"<%} %>
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">        
          <td width="120" class="label" height="24">定制化信息</td>
          <td width="*" class="content">
            <textarea rows="3" cols="40" name="Reserve1"></textarea>
          </td>
        </tr>
        <tr class="mouseout">
         <td width="120" class="label" height="24">协议用户编号</td>
          <td width="*" class="content">
