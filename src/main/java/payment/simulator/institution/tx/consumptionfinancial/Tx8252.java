...
import payment.api.tx.consumptionfinancial.Tx8252Request;
 ...
 * </pre>
 */
public class Tx8252 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8252Request txRequest = new Tx8252Request();
            ...
            request.setAttribute("txCode", "8252");
            request.setAttribute("txName", "红包发放查询");
