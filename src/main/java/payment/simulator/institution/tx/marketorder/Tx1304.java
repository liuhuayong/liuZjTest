...
import payment.api.tx.marketorder.Tx1304Request;

public class Tx1304 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // 2.创建交易请求对象
            Tx1304Request txRequest = new Tx1304Request();
            ...
            // //2个信息参数
            request.setAttribute("txCode", "1304");
            request.setAttribute("txName", "市场订单快捷支付（PC端）");
            // 1个action(支付平台地址)参数
