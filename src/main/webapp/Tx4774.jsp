...
function removeDiv(divID){
 var obj1 = document.getElementById("Loaner");
...
function addLoaner(){
	...
	div.id = divID;
	document.getElementById("Loaner").appendChild(div);
	var url = "<%=contextPath %>/Tx4774_1";
...
window.onload = function(){
   ...
   addLoaner();
    ...
    <%
        String action = contextPath + "/Tx4774";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="BatchNo" size="40" value="<%=GUIDGenerator.genHSGUID()%>" />
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <td width="*" class="content" id="Loaner">
        <a href="javascript:void(0)" onclick="addLoaner()">添加投资人</a>
        </td>
        </tr>
      </table>
