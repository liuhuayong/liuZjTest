  ...
  <body>
    ...
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <select id="OrderType" name="OrderType" style="width: 274">
              <option value="10">投资订单</option>
              <option value="20">还款订单</option>
            </select>
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>扣款账户类型</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>扣款账户名称</td>
          <td width="*" class="content">
            <input type="text" name="AccountName" size="40" value="扣款账户名称" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>扣款账户号码</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24">签名结果</td>
          <td width="*" class="content">
            <input type="text" name="SignData" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>签名证书类型</td>
          <td width="*" class="content">
            <select id="SignType" name="SignType" style="width: 274">
              <option value="10">验证签名</option>
              <option value="20">不验证签名</option>
            </select>
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="BankNo" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
      ...
      <input type="hidden" name="TxCode" value="7267" />
    </form>
