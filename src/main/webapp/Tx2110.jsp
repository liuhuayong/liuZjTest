...
<%
    String action = contextPath + "/Tx2110";
%>
...
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
      ...
      <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>代付客户ID</td>
        <td width="*" class="content">
          <input type="text" name="CustomerID" size="40" value="" />
        </td>
      </tr>
      <tr class="mouseout">
        <td width="120" class="label" height="24">代付客户交易授权码</td>
        <td width="*" class="content">
          <input type="text" name="CustomerTxCode" size="40" value="" />
        </td>
      </tr>
      <tr class="mouseout">
