...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7243";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="4">结算（7243）</td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          ...
          <td width="120" class="label" height="24">代扣交易流水号</td>
          <td width="*" class="content">
            <input type="text" name="GatheringNo" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24">CP投资流水号</td>
          <td width="*" class="content">
            <input type="text" name="InvestNo" size="40" value="" />
          </td>
          
          <td width="120" class="label" height="24">快捷支付流水号</td>
          <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="7243" />
    </form>
