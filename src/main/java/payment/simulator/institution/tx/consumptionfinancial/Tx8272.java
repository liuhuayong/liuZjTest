...
import payment.api.tx.consumptionfinancial.Tx8272Request;
 ...
 * </pre>
 */
public class Tx8272 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8272Request txRequest = new Tx8272Request();
            ...
            request.setAttribute("txCode", "8272");
