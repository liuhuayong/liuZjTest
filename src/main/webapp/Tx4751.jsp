...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx4751";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>电子账户号码</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>提现金额</td>
          <td width="*" class="content">
            <input type="text" name="Amount"  size="40" value="100" />
          </td>
        </tr>
         <tr class="mouseout">
          <td width="120" class="label" height="24">提现手续费</td>
          <td width="*" class="content">
            <input type="text" name="Fee"  size="40" value="10" />
          </td>
        </tr> 
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>是否指定通道</td>
          <td width="*" class="content">
            <select  name="RoutFlag"  style="width: 274"/>
            <option value="Y">指定资金通道</option>
            <option value="N">银行选择资金通道</option>
          </select>
        </tr> 
        <tr class="mouseout">
          <td width="120" class="label" height="24">通道标识</td>
          <td width="*" class="content">
            <input type="text" name="RoutCode"  size="40" value="" />
          </td>
        </tr> 
        <tr class="mouseout">
          <td width="120" class="label" height="24">开户银行联行号</td>
          <td width="*" class="content">
