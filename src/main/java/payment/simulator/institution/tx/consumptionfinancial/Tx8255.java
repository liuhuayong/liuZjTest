...
import payment.api.tx.consumptionfinancial.Tx8255Request;
 ...
 * </pre>
 */
public class Tx8255 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8255Request txRequest = new Tx8255Request();
            ...
            request.setAttribute("txName", "红包查询");
