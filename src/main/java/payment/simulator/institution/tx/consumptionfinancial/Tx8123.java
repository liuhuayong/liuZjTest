...
import payment.api.tx.consumptionfinancial.Tx8123Request;
...
public class Tx8123 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // 2.创建交易请求对象 
            Tx8123Request txRequest = new Tx8123Request();
            ...
            // //2个信息参数
            request.setAttribute("txCode", "8123");
            request.setAttribute("txName", "用户支付账户余额批量查询");
