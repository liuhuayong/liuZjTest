...
<%
    String action = contextPath + "/Tx5618";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">跨境出口交易匹配接口(5618)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">汇款交易流水号</td>
        <td width="*" class="content">
            <input type="text" name="SerialNumber" placeholder="必填" size="40" value=""/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24"> 交易匹配确认或者驳回</td>
        <td width="*" class="content">
            <select id="Match" name="Match" style="width: 265">
