...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7264";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">投资代扣退款（7264）</td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>原代扣交易流水号</td>
          <td width="*" class="content">
            <input type="text" name="GatheringNo" placeholder="必填" size="40" value="" />
          </td>
        </tr> 
        <tr class="mouseout">
