...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=contextPath%>/js/provbank.js"></script>
  </head>
  <body>
...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx2040";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="TxSN" size="40" placeholder="必填" value="" />
          </td>
        </tr>
      </table>
