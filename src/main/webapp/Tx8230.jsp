...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx8230";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">服务费扣收（8230）</td>
        </tr>
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>服务费类型</td>
          <td width="*" class="content">
            <select id="FeeType" name="FeeType" style="width: 274">
              <option value="10">贷款方服务费</option>
              <option value="20">平台方服务费</option>
              <option value="30">担保方服务费（预留）</option>
            </select>
          </td>
        </tr>
        
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>服务费用途</td>
          <td width="*" class="content">
            <select id="FeeUsage" name="FeeUsage" style="width: 274">
              <option value="10">放款</option>
              <option value="20">还款（预留）</option>
            </select>
          </td>
        </tr>

        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>清分金额</td>
          <td width="*" class="content">
