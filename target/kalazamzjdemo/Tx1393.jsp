...
<%
    String action = contextPath + "/Tx1393";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">市场订单认证支付（开通并支付，到银联页面）(1393)</td>
    </tr>
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="AccountNumber" size="40" value="6226388000000095"/><%if("20".equals(debugMode)){ %><font color="#FF0000" size="2">测试环境交易状态返回规则：账户号码是‘20’时返回失败状态；是其他值时返回成功状态</font><%} %>
        </td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">接收前台通知URL</td>
        <td width="*" class="content">
        <%
              String url = null;
