...
<%
    ...
    String uploadNo = GUID.genTxNo(GUID.LEN_27);
%>
<html>
<head>
...
<%
    String action = contextPath + "/Tx5633";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">订单还原明细上传通知</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">上传流水号</td>
        <td width="*" class="content">
            <input type="text" name="UploadNo" size="40" value="<%=uploadNo %>"/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24">收汇银行</td>
        <td width="*" class="content">
            <input type="text" name="ExchangeBankID" size="40" value=""/>
        </td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">文件存储路径</td>
        <td width="*" class="content">
            <input type="text" name="FilePath" size="40" value=""/>
        </td>
    </tr>
