...
import payment.api.tx.consumptionfinancial.Tx8250Request;
 ...
 * </pre>
 */
public class Tx8250 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.setAttribute("txCode", "8250");
            request.setAttribute("txName", "红包发放");
