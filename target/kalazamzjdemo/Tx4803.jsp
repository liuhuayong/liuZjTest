...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx4803";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
         ...
         <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>冻结交易流水号</td>
          <td width="*" class="content">
            <input type="text" name="SerialNumber" size="40" value="<%=GUIDGenerator.genHSGUID()%>" />
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">   
          <td width="120" class="label" height="24"><font color="red">*</font>还款冻结类型</td>
         <td width="*" class="content">
        ...
        <tr class="mouseout">   
         ...
         <td width="*" class="content">
            <select name="OperationType" style="width: 274">
            <option value="10">还款冻结</option>
            <option value="20">冻结撤销</option> 
            </select>
          </td>
        </tr>
        <tr class="mouseout">
