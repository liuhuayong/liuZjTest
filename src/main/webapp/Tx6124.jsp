...
<%
    String action = contextPath + "/Tx6124";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">支付账户实时代扣(天天基金定制接口)(6124)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">交易流水</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">金额</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="PaymentAccountName" size="40" value="Prince"/>
        </td>
    </tr>
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="PaymentAccountNumber" size="40" value="622222222222222222"/>
        </td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">充值交易流水</td>
        <td width="*" class="content">
            <input type="text" name="ChargeSN" placeholder="必填" size="40" value=""/>
        </td>
    </tr>
