...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx3211";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      ...
      P2P项目支付(托管户)(3211)
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="ProjectURL" size="40" value="http://www.investEasy.com/<%=projectName%>" />
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="StartDate" size="40" value="20140505" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>到期日</td>
          <td width="*" class="content">
            <input type="text" name="EndDate" size="40" value="20150505" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>投资人支付账户号码</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="LoaneePaymentAccountName" size="40" value="新融资人" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24">融资人支付账户号码</td>
          <td width="*" class="content">
            <input type="text" name="LoaneePaymentAccountNumber" size="40" value="14082816531330241827" />
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24">支付方式</td>
          <td width="*" class="content" >
