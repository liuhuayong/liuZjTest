...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7256";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>退款帐户名称</td>
          <td width="*" class="content">
            <input type="text" name=AccountName size="40" value="退款账号" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>退款账户号码</td>
          <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="7256" />
    </form>
