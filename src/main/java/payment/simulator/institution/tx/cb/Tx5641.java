...
import payment.api.tx.cb.Tx5641Request;
...
public class Tx5641 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            Tx5641Request txRequest = new Tx5641Request();
            ...
            req.setAttribute("txCode", "5641");
            req.setAttribute("txName", "B2C收款指令文件上传(含境内收款方信息)");
