...
import payment.api.tx.consumptionfinancial.Tx8222Request;
 ...
 * </pre>
 */
public class Tx8222 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8222Request txRequest = new Tx8222Request();
            ...
            request.setAttribute("txCode", "8222");
            request.setAttribute("txName", "贷款发放查询");
