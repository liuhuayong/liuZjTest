...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7261";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">投资/还款订单单笔代收(代收中间户)（7261）</td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <select name="OrderType" style="width:274px">
              <option value="10">10-投资订单</option>
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <select name="AccountType" style="width:274px">
                <option value="11">11-个人账户</option>
                <option value="12" selected="selected">12-企业账户</option>
            </select>
          </td>
        </tr> 
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="AccountName" size="40" value="测试金融机构" />
          </td>
        </tr> 
        <tr class="mouseout">
