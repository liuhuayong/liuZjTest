...
<%
    String action = contextPath + "/Tx7271";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">中间户账户明细查询（7271）</td>
    </tr>
    <tr class="mouseout">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>查询流水号</td>
        <td width="*" class="content">
            <input type="text" name="TxSN" size="40" value="<%=GUIDGenerator.genGUID() %>"/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>开始日期</td>
        <td width="*" class="content">
            <input type="text" name="StartDate" size="40" value="<%=today %>"/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>结束日期</td>
        <td width="*" class="content">
