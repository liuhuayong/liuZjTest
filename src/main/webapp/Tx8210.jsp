...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx8210";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">贷款项目发布（8210）</td>
        </tr>
        ...
        <tr class="mouseout">
          <td width="130" class="label" height="24"><font color="red">*</font>项目编号</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          <td width="130" class="label" height="24"><font color="red">*</font>项目名称</td>
          <td width="*" class="content">
            <input type="text" name="ProjectName" placeholder="必填" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="130" class="label" height="24"><font color="red">*</font>贷款金额</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          <td width="130" class="label" height="24"><font color="red">*</font>消耗收款账户类型</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          <td width="130" class="label" height="24">消耗收款银行ID</td>
          <td width="*" class="content">
            <input type="text" name="PayeeBankID" size="40" value="" />
          </td>
        </tr>         
        <tr class="mouseout">
          <td width="130" class="label" height="24">消耗收款分支行</td>
          <td width="*" class="content">
            <input type="text" name="PayeeBranchName" size="40" value="" />
          </td>
        </tr>         
        
        <tr class="mouseout">
          <td width="130" class="label" height="24"><font color="red">*</font>出资方机构编号</td>
          <td width="*" class="content">
            <input type="text" name="LoanerInstitutionID" placeholder="必填" size="40" value="" />
          </td>
        </tr>         
        
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方账户类型：</td>
          <td width="*" class="content">
            <select id="GuaranteeAccountType" name="GuaranteeAccountType" style="width: 274">
              <option value="">无担保</option>
              <option value="12">企业银行账户</option>
              <option value="20">支付账户</option>
            </select>
          </td>
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方支付账户名称（预留）</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteePaymentAccountName" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方支付账户号码（预留）</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteePaymentAccountNumber" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方账户名称</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteeAccountName" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方账户号码</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteeAccountNumber" size="40" value="" />
          </td>
        </tr>         
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方银行ID</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteeBankID" size="40" value="" />
          </td>
        </tr>         
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方分支行</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteeBranchName" size="40" value="" />
          </td>
        </tr>         
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方省份</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteeProvince" size="40" value="" />
          </td>
        </tr>         
        <tr class="mouseout">
          <td width="130" class="label" height="24">担保方城市</td>
          <td width="*" class="content">
            <input type="text" name="GuaranteeCity" size="40" value="" />
          </td>
        </tr>                                                          
      </table>
