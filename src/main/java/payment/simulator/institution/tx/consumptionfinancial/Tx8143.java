...
import payment.api.tx.consumptionfinancial.Tx8143Request;
...
public class Tx8143 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // 2.创建交易请求对象
            Tx8143Request txRequest = new Tx8143Request();
            ...
            request.setAttribute("txCode", "8143");
            request.setAttribute("txName", "用户支付账户银行账户绑定（同步）");
