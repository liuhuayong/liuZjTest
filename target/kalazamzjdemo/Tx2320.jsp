...
<html>
  ...
  <body>
    ...
    <%
        String action = contextPath + "/Tx2320";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>姓名</td>
          <td width="*" class="content">
            <input type="text" name="UserName" placeholder="必填" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>身份证号</td>
          <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="2320" />
    </form>
