...
window.onload = function(){
   ...
   addItem();
    ...
    <%
        String action = contextPath + "/Tx4811";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
         ...
         <td width="*" class="content">
            <select name="RepaymentType" style="width: 274">
            <option value="10">实际融资人</option>
            <option value="20">融资人</option>
            <option value="30">担保人</option> 
            </select>
          </td>
        </tr>
        <tr class="mouseout">
        <td width="120" class="label" height="24">还款结算</td>
        <td width="*" class="content" id="Item">
        <a href="javascript:void(0)" onclick="addItem()">添加还款结算</a>
        </td>
        </tr>
      </table>
