...
<%
String prettyPlainText = "";
Object obj = request.getAttribute("fileContent");
if(obj != null ){
	List fileContentList = (List)obj;
	StringBuffer sb = new StringBuffer();
    for(Object tradeInfo : fileContentList) {
        sb.append((String)tradeInfo);
        sb.append("\r\n");
        prettyPlainText = sb.toString();
    }
