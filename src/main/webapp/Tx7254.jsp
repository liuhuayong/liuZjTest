...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7254";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="4">结算(融资人结算)（7254）</td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>结算订单号</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <select id="SettlementType" name="SettlementType" style="width: 274">
              ...
              <option value ="60">CP投资人账户</option>
            </select>
          </td>
        </tr>
        <tr class="mouseout">
         <td width="120" class="label" height="24"><font color="red">*</font>金额白名单流水号</td>
          <td width="*" class="content">
            <input type="text" name="AmountWhiteListNo" placeholder="必填" size="40" value="" />
          </td>  
          </tr>
        <tr class="mouseout">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
      ...
      <input type="hidden" name="TxCode" value="7254" />
    </form>
