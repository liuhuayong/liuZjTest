...
import payment.api.tx.consumptionfinancial.Tx8211Request;
 ...
 * </pre>
 */
public class Tx8211 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8211Request txRequest = new Tx8211Request();
            ...
            request.setAttribute("txCode", "8211");
            request.setAttribute("txName", "贷款项目撤销");
