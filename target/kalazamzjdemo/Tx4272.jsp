...
<body>
  <div id="content">
    ...
    <%
      String action = path + "/Tx4272";
    %>
    <form action="<%=action%>" name="form1" method="POST">
    <input type="hidden" name="TxCode" value="4272" />
    <div id="mainbar" class="mainbar">
      <table class="tableForm">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="AgreementNo" id="AgreementNo" class="ui-input" placeholder="请输入签约号" value="<%=GUIDGenerator.genGUID()%>"/>
          </td>
          <td width="40px"><div class="close ui-close"></div></td>
        </tr>
        <tr>
          ...
          <td>
            <select name="AgreementType" id="AgreementType" class="ui-select">
              <option value="20">支付账户扣款</option>
              <option value="60">自动投资签约</option>
            </select>
          </td>
          <td></td>
        </tr>
        <tr>
          ...
          <td>
            <input type="text" name="PaymentAccountNumber" id="PaymentAccountNumber" class="ui-input" placeholder="请输入账户号码" value="800000000143"/>
          </td>
          <td width="40px"><div class="close ui-close"></div></td>
        </tr>
        <tr>
