...
<%
    String action = contextPath + "/Tx4540";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">机构支付账户单笔转账（支付账户->支付账户）(4540)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>转账交易流水号（保证唯一不能重复）</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>机构付款账户名称</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>机构付款账户号码</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>转账金额，单位：分</td>
        <td width="*" class="content">
