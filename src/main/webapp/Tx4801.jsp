...
function changeTotalFee(){
   var feeObj = document.getElementsByName("Fee");
   var countObj = document.getElementsByName("Count");
   var leng = feeObj.length;
   var totalFee = 0;
   var fee = 0;
   for(var i = 0; i < leng; i ++){
      fee = feeObj[i].value;
      count = countObj[i].value;
      if(fee != null && fee != ""){
             totalFee = parseInt(totalFee) + parseInt(fee)*parseInt(count);
...
window.onload = function(){
   ...
   addItem();
    ...
    <%
        String action = contextPath + "/Tx4801";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">   
          <td width="120" class="label" height="24"><font color="red">*</font>融资人类型</td>
         <td width="*" class="content">
            <select name="LoaneeType" style="width: 274">
            <option value="10">实际融资人</option>
            <option value="20">名义融资人</option>
            </select>
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td class="label" height="24"><font color="red">*</font>总服务费</td>
          <td width="*" class="content">
           <input type="text" id="TotalFee" name="TotalFee" size="40" value="0"/>
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
        <td width="120" class="label" height="24">融资结算</td>
        <td width="*" class="content" id="Item">
        <a href="javascript:void(0)" onclick="addItem()">添加融资结算</a>
        </td>
        </tr>
      </table>
