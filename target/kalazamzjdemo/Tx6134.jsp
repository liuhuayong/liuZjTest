...
<%
    String action = contextPath + "/Tx6134";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">账户收支查询(6134)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">交易时间（开始）</td>
        <td width="*" class="content">
            <input type="text" name="StartDate" size="40" value="20160811"/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24">交易时间（结束）</td>
        <td width="*" class="content">
            <input type="text" name="EndDate" size="40" value="20160811"/>
        </td>
    </tr>
