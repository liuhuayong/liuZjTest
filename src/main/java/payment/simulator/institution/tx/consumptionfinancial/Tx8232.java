...
import payment.api.tx.consumptionfinancial.Tx8232Request;
 ...
 * </pre>
 */
public class Tx8232 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8232Request txRequest = new Tx8232Request();
            ...
            request.setAttribute("txCode", "8232");
            request.setAttribute("txName", "服务费扣收查询");
