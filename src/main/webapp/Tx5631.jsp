...
function changeTotalAmount(){
   var amountObj = document.getElementsByName("ReceiveAmount");
   ...
   document.getElementById("PageTotalAmount").value = totalAmount;
}
...
function changeTotalCount(){
   ...
   document.getElementById("PageTotalCount").value = totalCount;
}
...
<%
    String action = contextPath + "/Tx5631";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">B2C收款指令批量分页提交(5631)</td>
    </tr>
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="BankID" size="40" value="104"/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24">总金额，单位：分</td>
        <td width="*" class="content">
            <input type="text" name="TotalAmount" size="40" value="10000"/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24">总笔数</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">当前页总金额</td>
        <td width="*" class="content">
            <input id="PageTotalAmount" type="text" name="PageTotalAmount" size="40" value="2000"/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24">当前页总笔数</td>
        <td width="*" class="content">
            <input id="PageTotalCount" type="text" name="PageTotalCount" size="40" value="1"/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24">下一页标志：</td>
        <td width="*" class="content">
            <select name="NextPage">
              <option value="0">0-无下一页</option>
              <option value="1">1-有下一页</option>
            </select>
        </td>
    </tr>
