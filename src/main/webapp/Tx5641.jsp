...
<%
    String action = contextPath + "/Tx5641";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">B2C收款指令文件上传-含境内收款方(5641)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">批次号</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">文件名称</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">文件的MD5签名串</td>
        <td width="*" class="content">
