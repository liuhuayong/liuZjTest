...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx8250";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">红包发放（8250）</td>
        </tr>
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>红包编号</td>
          <td width="*" class="content">
            <input type="text" name="CouponNo" placeholder="必填" size="40" value="" />
          </td>
        </tr>
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>红包类型</td>
          <td width="*" class="content">
            <select id="CouponType" name="CouponType" style="width: 274">
              <option value="10">优惠券</option>
              <option value="20">现金红包(预留)</option>
            </select>
          </td>
        </tr>

        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>红包金额</td>
          <td width="*" class="content">
