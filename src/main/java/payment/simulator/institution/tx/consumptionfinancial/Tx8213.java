...
import payment.api.tx.consumptionfinancial.Tx8213Request;
 ...
 * </pre>
 */
public class Tx8213 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8213Request txRequest = new Tx8213Request();
            ...
            request.setAttribute("txCode", "8213");
            request.setAttribute("txName", "贷款项目撤销查询");
