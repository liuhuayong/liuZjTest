...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx4771";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="PaymentNo" size="40" value="<%=GUIDGenerator.genHSGUID()%>" />
          </td>
        </tr>
        <tr class="mouseout">
         ...
         <tr class="mouseout">   
          <td width="120" class="label" height="24"><font color="red">*</font>是否使用红包</td>
         <td width="*" class="content">
            <select name="CouponFlag" style="width: 274">
            <option value="10">不使用</option>
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>投资人电子账户</td>
          <td width="*" class="content">
