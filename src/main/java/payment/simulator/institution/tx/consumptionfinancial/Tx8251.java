...
import payment.api.tx.consumptionfinancial.Tx8251Request;
 ...
 * </pre>
 */
public class Tx8251 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8251Request txRequest = new Tx8251Request();
            ...
            request.setAttribute("txCode", "8251");
            request.setAttribute("txName", "红包撤销");
