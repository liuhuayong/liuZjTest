...
import payment.api.tx.consumptionfinancial.Tx8221Request;
 ...
 * </pre>
 */
public class Tx8221 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8221Request txRequest = new Tx8221Request();
            ...
            request.setAttribute("txCode", "8221");
            request.setAttribute("txName", "贷款撤销");
