...
import payment.api.tx.consumptionfinancial.Tx8142Request;
 ...
 * </pre>
 */
public class Tx8142 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8142Request txRequest = new Tx8142Request();
            ...
            request.setAttribute("txCode", "8142");
            request.setAttribute("txName", "用户支付账户银行账户绑定状态查询");
