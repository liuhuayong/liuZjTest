...
<%
    String action = contextPath + "/Tx4241";
%>
<form action='<%=action%>' name='form1' method='POST'>
<table width='100%' cellpadding='2' cellspacing='1' border='0' align='center' bgcolor='#DDDDDD'>
    <tr>
        <td class='head' height='24' colspan='2'>用户支付账户银行账户绑定（托管户）（4241）</td>
    </tr>
    ...
    <tr class='mouseout'>
        <td width='120' class='label' height='24'>银行账户绑定流水号</td>
        <td width='*' class='content'>
    ...
    <tr class='mouseout'>
        ...
        <%if("20".equals(debugMode)){ %><font color="#FF0000" size="2">测试环境交易状态返回规则：进入绑卡页面后，银行卡号末两位是‘10’返回成功状态；‘20’返回失败状态；‘30’返回处理中状态</font><%} %>
        </td>
    </tr>
