...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx2310";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="AccountNumber" size="40" value=6222020200002432 /><%if("20".equals(debugMode)){ %><font color="#FF0000" size="2">测试环境交易状态返回规则：账户号码末两位是‘10’返回匹配状态；‘20’返回不匹配状态</font><%} %>
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24">证件类型</td>
          <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="2310" />
    </form>
