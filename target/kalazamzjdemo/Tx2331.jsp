...
<%
    String action = contextPath + "/Tx2331";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">短息下发（支付账号） (2331)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>关联交易类型</td>
        <td width="*" class="content">
            <input type="text" name="TxType" placeholder="必填" size="40" value=""/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>支付账号</td>
        <td width="*" class="content">
