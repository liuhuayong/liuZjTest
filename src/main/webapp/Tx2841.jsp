...
<%
    String action = contextPath + "/Tx2841";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">订单关闭（二维码）（2841）</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>订单关闭流水号</td>
        <td width="*" class="content">
            <input type="text" name="CloseNo" size="40" value="<%=GUIDGenerator.genGUID()%>"/>
        </td>
    </tr>
