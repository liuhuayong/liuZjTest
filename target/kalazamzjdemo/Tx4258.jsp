...
<body>
  <div id="content">
    ...
    <%
      String action = path + "/Tx4258";
    %>
    <form action="<%=action%>" name="form1" method="POST">
    <input type="hidden" name="TxCode" value="4258" />
    <div id="mainbar" class="mainbar">
      <table class="tableForm">
        ...
        <tr>
          <th><font color="red">*</font>提现手续费：</th>
          <td>
            <input type="text" name="InstitutionFee" id="InstitutionFee" class="ui-input" value="0"/>
          </td>
          <td><div class="close ui-close"></div></td>
        </tr> 
