  ...
  <div id="content">
    ...
    <div id="mainbar" class="mainbar">
      <table class="tableForm">
      	 <tr>
          <th colspan="3">市场订单快捷支付（移动端）（1305）</th>
        <tr>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="Amount" id="Amount" class="ui-input" value="1000"/>
          </td>
          <td><div class="close ui-close"></div></td>
        </tr>
        <tr>
      ...
      <input type="hidden" name="TxCode" value="1305" />
    </div>
