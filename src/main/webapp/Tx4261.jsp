...
<%
    String action = contextPath + "/Tx4261";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">用户支付账户扣款签约（4261）</td>
    </tr>
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="PageURL" size="40" value="<%=request.getRequestURL().substring(0, request.getRequestURL().indexOf(request.getRequestURI()) + request.getContextPath().length())%>/ReceiveNoticePage"/>
        </td>
    </tr>
