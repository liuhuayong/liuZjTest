...
import payment.api.tx.consumptionfinancial.Tx8145Request;
...
public class Tx8145 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // 2.创建交易请求对象
            Tx8145Request txRequest = new Tx8145Request();
            ...
            request.setAttribute("txCode", "8145");
