...
<%
    String action = contextPath + "/Tx1930";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">一站式代收付明细查询（1930）</td>
    </tr>
    <tr class="mouseout">
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="BatchNo" placeholder="必填" size="40" maxlength="32" value=""/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>记录流水号</td>
        <td width="*" class="content">
            <input type="text" name="ItemNo" placeholder="必填" size="40" maxlength="32" value=""/>
        </td>
    </tr>
</table>
