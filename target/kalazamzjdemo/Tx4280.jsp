...
<%
    String action = contextPath + "/Tx4280";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">用户支付账户余额利息批量查询（4280）</td>
    </tr>
    <tr class="mouseout">
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="Date" size="40" value="2016-08-01"/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24">页码</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="CountPerPage" size="40" value="50"/>
        </td>
    </tr>
</table>
