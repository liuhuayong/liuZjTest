...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7131";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">投资人退款（7131）</td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24">退款交易流水号</td>
          <td width="*" class="content">
            <input type="text" name="TxSN" size="40" value="0000211111110" />
          </td>
        </tr>
       <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24">结算金额</td>
          <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="7131" />
    </form>
