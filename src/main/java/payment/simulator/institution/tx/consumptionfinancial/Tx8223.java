...
import payment.api.tx.consumptionfinancial.Tx8223Request;
 ...
 * </pre>
 */
public class Tx8223 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8223Request txRequest = new Tx8223Request();
            ...
            request.setAttribute("txCode", "8223");
            request.setAttribute("txName", "贷款撤销查询");
