...
<%
    String action = contextPath + "/Tx1402";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">反扫支付（1402）</td>
    </tr>
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="Subject" placeholder="必填" size="40" value=""/><%if("20".equals(debugMode)){ %><font color="#FF0000" size="2">测试环境交易状态返回规则：商品描述字段填‘10’返回成功状态；填‘20’返回失败状态；填‘30’返回未支付状态</font><%} %>
            
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24">可打折金额</td>
        <td width="*" class="content">
            <input type="text" name="DiscountAmount" size="40" value="0"/>
        </td>
    </tr> 
    <tr class="mouseout">
