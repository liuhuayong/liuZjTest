    ...
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name=TokenPaymentNo size="40" value="<%=GUIDGenerator.genGUID()%>" />
          </td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>Token标识</td>
          <td width="*" class="content">
            <input type="text" name=Token size="40" value="1234567" />
          </td>
        </tr>
        <tr class="mouseout">
      ...
      <input type="hidden" name="TxCode" value="7214" />
    </form>
