...
<%
    String action = contextPath + "/Tx6132";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">基金参数查询(6132)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">交易时间 </td>
        <td width="*" class="content">
            <input type="text" name="NetDate" size="40" value="20160811"/>
        </td>
    </tr>
