...
<%
    String action = contextPath + "/Tx2232";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">O2O订单支付退款查询（2232）</td>
    </tr>
    <tr class="mouseout">
        <td width="140" class="label" height="24"><font color="red">*</font>机构编号</td>
        <td width="*" class="content">
            <input type="text" name="InstitutionID" size="40" value="000020"/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="140" class="label" height="24"><font color="red">*</font>退款交易流水号</td>
        <td width="*" class="content">
