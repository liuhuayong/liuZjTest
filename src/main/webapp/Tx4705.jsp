...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx4705";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>操作</td>
          <td width="*" class="content">
            <select name="Option" style="width: 274">
         ...
         <tr class="mouseout">
          <td width="120" class="label" height="24">变更后手机号</td>
          <td width="*" class="content">
            <input type="text" name="PhoneNumber"  size="40" value="" />
          </td>
        </tr>
         <tr class="mouseout">
          <td width="120" class="label" height="24">变更前手机号</td>
          <td width="*" class="content">
            <input type="text" name="OldPhoneNumber"  size="40" value="" />
          </td>
        </tr>
