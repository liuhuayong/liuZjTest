...
<%
  String action = request.getContextPath() + "/Tx4246";
%>
...
<body>
  <div id="content">
    ...
    <form action="<%=action%>" name="form1" method="POST">
      <input type="hidden" name="TxCode" value="4246" />
      <div id="mainbar" class="mainbar">
        <table class="tableForm">
          <tr>
            <th width="150px"><font color="red">*</font>机构编号：</th>
            <td>
                <input type='text' name='InstitutionID' id='InstitutionID' class="ui-input" placeholder="请输入机构编号" value='000020'/>
            </td>
              <td>
          ...
          <tr>
              <th><font color="red">*</font>银行卡绑定流水号：</th>
              <td>
                  <input type='text' name='BindingSystemNo' id='BindingSystemNo' class="ui-input" placeholder="请输入绑定流水号" value=""/>
              </td>
              <td>
                <div class="close ui-close"></div>
              </td>
