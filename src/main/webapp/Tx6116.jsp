...
<%
    String action = contextPath + "/Tx6116";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">解绑(6116)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">解绑交易流水号</td>
        <td width="*" class="content">
            <input type="text" name="UnBindingSN" size="40" value="<%=GUIDGenerator.genGUID()%>"/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24">绑卡交易流水号</td>
        <td width="*" class="content">
