...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx8134";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">账户手机运营商认证交易查询（8134）</td>
        </tr>
        ...
        <tr class="mouseout">
          <td width="130" class="label" height="24"><font color="red">*</font>手机号认证交易流水号</td>
          <td width="*" class="content">
            <input type="text" name="MoblieVeriTxNo" size="40" value="" />
          </td>
        </tr>                                                                
      </table>
