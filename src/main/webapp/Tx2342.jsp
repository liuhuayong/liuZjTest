...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx2342";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>原交易流水号</td>
          <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="2342" />
    </form>
