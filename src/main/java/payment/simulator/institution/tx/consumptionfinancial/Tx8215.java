...
import payment.api.tx.consumptionfinancial.Tx8215Request;
 ...
 * </pre>
 */
public class Tx8215 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8215Request txRequest = new Tx8215Request();
            ...
            request.setAttribute("txCode", "8215");
            request.setAttribute("txName", "贷款项目查询");
