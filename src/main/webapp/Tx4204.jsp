...
<body>
  <div id="content">
    ...
    <%
      String action = path + "/Tx4204";
    %>
    <form action="<%=action%>" name="form1" method="POST">
    <input type="hidden" name="TxCode" value="4204" />
    <div id="mainbar" class="mainbar">
      <table class="tableForm">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="RegisterNo" id="RegisterNo" class="ui-input" placeholder="请输入注册编号" value="<%=GUIDGenerator.genGUID()%>"/>
          </td>
