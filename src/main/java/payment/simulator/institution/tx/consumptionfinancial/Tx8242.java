...
import payment.api.tx.consumptionfinancial.Tx8242Request;
 ...
 * </pre>
 */
public class Tx8242 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // 1.创建交易请求对象
            Tx8242Request txRequest = new Tx8242Request();
            ...
            request.setAttribute("txCode", "8242");
            request.setAttribute("txName", "贷款消耗查询");
