...
<%
    String action = contextPath + "/Tx7233";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">金额白名单上传（7233）</td>
    </tr>
    <tr class="mouseout">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>金额白名单编号</td>
        <td width="*" class="content">
            <input type="text" name="AmountWhiteListNo" placeholder="必填" size="40" value=""/>
        </td>
    </tr>
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>账户白名单编号</td>
        <td width="*" class="content">
