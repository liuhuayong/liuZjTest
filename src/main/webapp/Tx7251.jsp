...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx7251";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        <tr>
          <td class="head" height="24" colspan="2">融资人支付（7251）</td>
        </tr>
        <tr class="mouseout">
        ...
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>付款银行ID</td>
          <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="7251" />
    </form>
