...
<body>
  <div id="content">
    ...
    <%
      String action = path + "/Tx4254";
    %>
    <form action="<%=action%>" name="form1" method="POST">
    <input type="hidden" name="TxCode" value="4254" />
    <div id="mainbar" class="mainbar">
      <table class="tableForm">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="PaymentNo" id="PaymentNo" class="ui-input" placeholder="请输入充值流水号" value="<%=GUIDGenerator.genGUID()%>"/>
          </td>
          <td><div class="close ui-close"></div></td>
        </tr>
        <tr>
          ...
          <td>
            <input type="text" name="Amount" id="Amount" class="ui-input" placeholder="请输入支付金额" value="1"/>
          </td>
          <td><div class="close ui-close"></div></td>
        </tr>        
        <tr>
