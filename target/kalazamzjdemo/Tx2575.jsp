...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx2575";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <input type="text" name="TxSNBinding" size="40" value="" />
          </td>
        </tr>
         <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>用户IP或所在地</td>
          <td width="*" class="content">
            <input type="text" name="Location" size="40" value="" />
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>是否发送密码短信</td>
          <td width="*" class="content">
            <input type="text" name="NotSendPwd" size="40" value="" />
          </td>
        </tr>
      </table>
      ...
      <input type="hidden" name="TxCode" value="2575" />
    </form>
