...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx1131";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          <td width="180" class="label" height="24"><font color="red">*</font>机构号码</td>
        ...
        <tr class="mouseout">
          ...
          <td width="*" class="content">
            <select name="AccountType" id="AccountType" style="width: 274" onchange="showRule()">
              <option value="<%=PaymentEnvironment.PERSONAL_ACCOUNT%>">个人账户</option>
              <option value="<%=PaymentEnvironment.BUSINESS_ACCOUNT%>">企业账户</option>
              <option value="<%=PaymentEnvironment.PAYMENT_ACCOUNT%>">支付平台账户</option>
            </select>
          </td>
        </tr>
