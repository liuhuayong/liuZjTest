...
import payment.api.tx.cb.Tx5636Request;

public class Tx5636 extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws ServletException,IOException{
		try{
			...
			Tx5636Request txRequest = new Tx5636Request();
			...
			req.setAttribute("txCode","5636");
			req.setAttribute("txName","B2C收款指令文件处理结果查询（按批次号）");
